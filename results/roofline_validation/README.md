...
| link_us | points | max DES throughput error | mean DES throughput error |
|---:|---:|---:|---:|
| 4 | 47 | 32.98% | -8.00% |
| 6 | 46 | 32.08% | -8.28% |
| 12 | 46 | 30.50% | -10.59% |
...
The DES replay can sit below the analytical curve because it uses finite
microbatch/resource scheduling, while the analytical Pareto model amortizes
pipeline fill/drain more aggressively.
