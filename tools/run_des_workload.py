...
def run(args):
    ...
    config = DESConfig(
        ...
        des_batch_decode=args.des_batch_decode,
        des_max_batch_size=args.des_max_batch_size,
...
def main():
    ...
    parser.add_argument("--des-batch-decode", action="store_true")
    parser.add_argument("--des-max-batch-size", type=int, default=512)
